...
impl ProjectStore {
    ...
    pub async fn get_by_worktree(&self, worktree: &str) -> Result<Option<ProjectRecord>, StorageError> {
...
impl WorkspaceStore {
    ...
    pub async fn create(&self, input: WorkspaceCreateInput) -> Result<WorkspaceRecord, StorageError> {
        let now = chrono::Utc::now().timestamp_millis();
        let workspace = WorkspaceRecord {
            id: format!("ws_{}", &crate::util::generate_uuid().replace('-', "")[..12]),
    ...
    pub async fn list_for_project(&self, project_id: &str) -> Result<Vec<WorkspaceRecord>, StorageError> {
...
mod tests {
    ...
    fn create_test_stores() -> (ProjectStore, WorkspaceStore, TempDir) {
        ...
        (ProjectStore::new(backend.clone()), WorkspaceStore::new(backend), temp)
    }
    ...
    async fn test_project_create() {
        ...
        let project = store.create(ProjectCreateInput {
    ...
    async fn test_project_get() {
        ...
        let created = store.create(ProjectCreateInput {
    ...
    async fn test_project_list() {
        ...
        store.create(ProjectCreateInput {
    ...
    async fn test_workspace_create() {
        ...
        let workspace = store.create(WorkspaceCreateInput {
    ...
    async fn test_workspace_list_for_project() {
        ...
        store.create(WorkspaceCreateInput {
